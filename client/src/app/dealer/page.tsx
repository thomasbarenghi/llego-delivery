      ...
      <section className='flex w-full flex-col-reverse items-center justify-center  2xl:container md:grid md:grid-cols-2 md:gap-10 '>
        <div className='flex flex-col items-start gap-2 pb-10 md:pb-0 '>
          <h1 className='text-3xl font-light'>
            <b className='font-semibold'>Gana dinero</b> repartiendo con tu moto
          </h1>
          <p>LleGo! es una plataforma que te permite conectar con negocios para realizar sus entregas</p>
        ...
        <div className='relative w-full py-10'>
          <div className='relative aspect-square w-full sm:aspect-auto sm:h-[300px] md:h-[400px] '>
            <Image src='/image/dealer-hero.jpg' alt='Hero image' fill objectFit='cover' className='rounded-full' />
          </div>
        </div>
      </section>
    </main>
